...
func (s *SettingService) GetExternalAPIKey() (string, error) {
	return s.getString("externalApiKey")
}

func (s *SettingService) SetExternalAPIKey(key string) error {
	return s.setString("externalApiKey", key)
}
